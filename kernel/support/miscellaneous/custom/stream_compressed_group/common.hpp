    ...
    struct Common
    {
            ...
            DataStreamView &stream) -> void
        {
            ...
            for (auto &subgroup : subgroup_information_list)
            {
                ...
                try_assert(resource_content_information.version == k_resource_content_information_version, "invalid_resource_content_version in exchange_stream_resource_group");
                ...
                try_assert(content_data_string.size() == static_cast<size_t>(resource_content_information.information_string_size), "invalid_resource_content_size in exchange_stream_resource_group");
